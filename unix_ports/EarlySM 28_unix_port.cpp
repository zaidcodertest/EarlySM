...
void ln()
{
    ...
    while (loopln == "0")
    {
        ...
        std::cin >> number;
        std::cout << "\n";
        std::cout << "The absolute value of " << number << " is: " << std::abs(number);
        std::cout << "\n";
        std::cout << "The cubic root of " << number << " is: " << cbrt(number);
        std::cout << "\n";
        std::cout << "The truth(1) of " << number << " being finite or it being false(0) is: " << std::isfinite(number);
        std::cout << "\n";
        std::cout << "The truth(1) of " << number << " being normal or it being false(0) is: " << std::isnormal(number);
        std::cout << "\n";
